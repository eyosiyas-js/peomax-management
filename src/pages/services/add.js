...
import { selectRestaurantDetails } from 'src/redux/features/userSlice'
...
export default function Page() {
  ...
  const CheckValid = () => {
    if (files.length <= 0 || !selectedButton) return false
    return true
  }

  ;<Button disabled={!CheckValid()} onClick={handleFinish}>
    Finish
  </Button>
