...
import Step1 from 'src/components/addRestaurant/step1/Step1'
import Step2 from 'src/components/addRestaurant/step2/Step2'
import Step3 from 'src/components/addRestaurant/step3/Step3'
    ...
    try {
      if (files.length > 0) {
        await Axiosinstance.put(
          `/api/${editInfo.category}s/${editInfo.id}/edit?files=true`,
          formData,
          {
            headers: {
        ...
        await Axiosinstance.put(
          `/api/${editInfo.category}s/${editInfo.id}/edit`,
          formData,
          {
            headers: {
              'Content-Type': 'multipart/form-data',
